...
from src.datamodules.datasets.frozen_section_ds import (
    CtranspathFrozenSectionDataset,
    MetaCtranspathFrozenSectionDataset,
    Resnet50FrozenSectionDataset,
)
...
class FrozenSectionMetaDataModule(BaseDataModule):
    def __init__(self, data_cfg: Dict[str, Any], split_provider: Optional[SplitProvider] = None,
                 *args: Any, **kwargs: Any) -> None:
        super().__init__(data_cfg, split_provider=split_provider, *args, **kwargs)
        self.train_dataset: Optional[MetaCtranspathFrozenSectionDataset] = None
        self.val_dataset: Optional[MetaCtranspathFrozenSectionDataset] = None
        self.test_dataset: Optional[MetaCtranspathFrozenSectionDataset] = None
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        self.train_dataset = MetaCtranspathFrozenSectionDataset(
            [self.data[idx] for idx in split.train.tolist()],
        )
        self.val_dataset = MetaCtranspathFrozenSectionDataset(
            [self.data[idx] for idx in split.val.tolist()],
        )
        self.test_dataset = MetaCtranspathFrozenSectionDataset(
            [self.data[idx] for idx in split.test.tolist()],
        )
        self.emit_data_artifacts()
